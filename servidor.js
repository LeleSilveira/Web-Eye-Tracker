...
localIpV4Address().then(function (ipAddress) {
  ...
  console.log(
    `Pagina eyetracker e transmissao da tela => https://${ipAddress}:8083/tracker/index.html`
  );
  // console.log(`Pagina captura e transmissao da tela => https://${ipAddress}:8083/captura_tela/transmitir_tela.html`);
  console.log(
    `Pagina exibir tela capturada => https://${ipAddress}:8083/captura_tela/assistir_tela.html`
  );
});
